...
const UpdateAppointmentLocalEvent = require("./UpdateLocalEventAppointment");
...
exports.UpdateAppointmentLocalEvent = functions.https.onRequest(
  UpdateAppointmentLocalEvent
);
